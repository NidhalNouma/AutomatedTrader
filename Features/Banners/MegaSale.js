...
function MegaSale() {
  ...
  return (
    <div className="w-full relative h-[50vh] z-0">
      {/* <div className="absolute top-[-135%] left-0 right-0 aspect-square bg-gradient-to-b from-accent to-primary rounded-full"></div> */}
      <div
        className="absolute top[-10%] left-0 right-0 h-full w-full bg-gradient-to-b from-bgt to-primary"
        style={{
          clipPath: "circle(46% at 50% 0)",
        }}
      ></div>
      <div className="z-10 relative w-full h-full flex flex-col items-center justify-start pt-11">
        ...
        <p className="text-text-p text-3xl text-center mt-4">
          Save up to <span className="font-extrabold text-text-h">%60</span>{" "}
          with lifetime membership and get access
          <br />
