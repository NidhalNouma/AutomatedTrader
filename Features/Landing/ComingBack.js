  ...
  return (
    <section className="flex-col items-center justify-center max-h-[120vh] overflow-hidden">
      <div className="max-w-5xl mt-[20vh] pb-16 mx-auto">
        ...
        >
          <Link href="/signup">
            <div className="mt-6 cursor-pointer text-text-h border-4 bg-gradient-to-rx from-primary to-secondary border-primary rounded-full inline-flex items-center py-3 font-semibold text-black transition duration-500 ease-in-out transform bg-transparent bg-white px-7 text-md md:mt-0 hover:text-black hover:bg-white focus:shadow-outline">
      ...
      >
        ...
        <img
          className="object-cover object-center w-[100%] mb-10 rounded-xl border-0 z-0 scale-100"
