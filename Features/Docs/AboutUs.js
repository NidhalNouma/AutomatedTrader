  ...
  return (
    <Index>
      ...
      <p className="mt-3 text-text-p text-sm">
        ...
        revolutionary platform that aims to empower traders to automate their
        trading strategies using cutting-edge technology. With our user-friendly
        interface, advanced trading tools, and real-time data , we enable
      ...
      <p className="mt-3 text-text-p text-sm">
        ...
        strategies emerging every day. AutomatedTrader.com is a leading platform
        that offers traders the tools they need to keep pace with this
        ever-changing landscape. By providing a comprehensive suite of automated
        trading solutions, we enable traders to optimize their performance and
      ...
      <p className="mt-3 text-text-p text-sm">
        ...
        that our platform is always available and that traders can access their
      ...
      <p className="mt-3 text-text-p text-sm">
        ...
        based on machine learning and tradingview alerts, which means that they
        can adapt to changing market conditions and identify trends that are not
        immediately obvious to the human eye. Our trading tools also incorporate
        advanced risk management strategies, which help to mitigate losses and
        maximize profits.
      </p>
      ...
      <p className="mt-3 text-text-p text-sm">
        We take security very seriously, and our platform is designed to ensure
        that traders data are always secure. We use the latest encryption
        technologies to protect user data and transactions, and our platform is
        regularly audited by independent third-party security experts to ensure
        that it is always up-to-date with the latest security standards.
      </p>

      <H5 className="font-bold mt-6">Benefits</H5>
      <p className="mt-3 text-text-p text-sm">
        <span className="font-semibold">AutomatedTrader.com </span>offers a
        number of benefits to traders, including:
        <br />
        <br />
        ...
        means that they can execute trades quickly and efficiently, without the
        ...
        <br />
        <br />
        <span className="font-semibold">3. </span>Risk Mitigation: Our platform
        incorporates advanced risk management strategies, which help to minimize
        losses and protect traders funds.
        <br />
        <br />
        <span className="font-semibold">4. </span>Accessibility: Our platform is
        cloud-based, which means that traders can access their accounts from
